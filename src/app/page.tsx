...
export default async function Home() {
  ...
  return (
    <HydrateClient>
      <header className="body-font border-b-2 text-gray-600">
        <div className="container mx-auto flex flex-col flex-wrap items-center p-5 md:flex-row">
          <a className="title-font mb-4 flex items-center font-medium text-gray-900 md:mb-0">
            ...
            <span className="ml-3 text-xl">Gementar Resume</span>
          </a>
        ...
        <div className="container mx-auto flex flex-col items-center px-5 py-24 md:flex-row">
          <div className="mb-16 flex flex-col items-center text-center md:mb-0 md:w-1/2 md:items-start md:pr-16 md:text-left lg:flex-grow lg:pr-24">
            ...
            <div className="mb-8 leading-relaxed">
              Professionally designed resume template to help you showcase your skills, experience, and achievements effectively. This template is tailored to highlight the unique qualifications and talents of our academy members.
            </div>
            <div className="flex w-full items-end justify-center md:justify-start">
              ...
              <button className="inline-flex rounded border-0 bg-red-500 px-6 py-2 text-lg text-white hover:bg-red-600 focus:outline-none">
                Get Free E-Resume
              </button>
            </div>
            <div className="mb-8 mt-2 w-full text-sm text-gray-500">
      ...
      <section className="body-font text-gray-600">
        <div className="container mx-auto px-5 py-24">
          <div className="mb-20 text-center">
            ...
            <div className="text-gray-500s mx-auto text-base leading-relaxed lg:w-3/4 xl:w-2/4">
      ...
      <footer className="body-font border-t-2 text-gray-600">
        <div className="container mx-auto flex flex-col items-center px-5 py-3 sm:flex-row">
          <a className="title-font flex items-center justify-center font-medium text-gray-900 md:justify-start">
            ...
            <span className="ml-3 text-xl">Gementar Team</span>
          </a>
          <div className="mt-4 text-sm text-gray-500 sm:ml-4 sm:mt-0 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:pl-4">
            <div className="font-bold">
              © Copyright 2024 Gementar Team Enterprise
            </div>
            <div className="text-xs">Reg. No. (003547603-A/202303286159)</div>
          </div>
